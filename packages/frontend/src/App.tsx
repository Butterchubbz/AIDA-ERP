...
const EUReturnsView = React.lazy(() => import('./pages/EUReturnsView'));
const ShippingHistoryView = React.lazy(() => import('./pages/ShippingHistoryView'));
    ...
    >
      <Routes>
        ...
        >
          ...
          <Route path="logistics/returns" element={<EUReturnsView />} />
